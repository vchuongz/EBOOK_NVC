...
public class MessageKeys {
    ...
    public static final String INSERT_SHOP_SUCCESSFULLY = "insert.shop.successfully";
    public static final String INSERT_SHOP_FAILED = "insert.shop.failed";
    public static final String UPDATE_SHOP_SUCCESSFULLY = "update.shop.successfully";

    public static final String UPDATE_SHOP_FAILED = "update.shop.failed";
    public static final String DELETE_SHOP_SUCCESSFULLY = "delete.shop.successfully";
